  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-1 min-w-0">
        ...
        <h4 
          className="text-sm font-medium text-foreground leading-tight truncate cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors select-none"
          onClick={(e) => {
            e.stopPropagation();
            e.preventDefault();
            onEdit?.(id);
