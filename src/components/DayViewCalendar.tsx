...
const ScheduledTaskBlock = ({ task, projects, onRemove, onEdit, onTaskComplete }: ScheduledTaskBlockProps) => {
  ...
  return (
    <div
      ...
      className={cn(
        "rounded-lg p-1.5 transition-all duration-200 h-full min-h-full flex flex-col justify-center cursor-grab active:cursor-grabbing hover:shadow-md group relative text-white",
    ...
    >
      ...
      <div className="absolute top-2 left-2 z-20">
        <Checkbox
          ...
          className="rounded-sm bg-white/80 hover:bg-white h-3.5 w-3.5 border-0"
        />
      </div>
