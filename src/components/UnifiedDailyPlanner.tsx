                    ...
                    >
                       {timeBlocks
                         .filter(block => {
                           ...
                           // Only show events in the time slot where they START
                           // For first half hour: show events that start between hour:00 and hour:29
                    ...
                    >
                       {timeBlocks
                         .filter(block => {
                           ...
                           // Only show events in the time slot where they START
                           // For second half hour: show events that start between hour:30 and hour:59
